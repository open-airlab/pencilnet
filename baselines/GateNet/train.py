...
from networks import standart_model, dronet
from losses import my_loss, absolute_value_loss, my_loss_2, my_loss_2_1, my_loss_2_2, my_loss_2_2_large
...
config['info'] = 'au-dr, epoch 100  rmsprop and USE my_loss_2_2 and lr 0.001'
...
# Load the model.
model = standart_model(config)
logger.set_network(standart_model)


# Compile the model.
opt = config['optimizer']
model.compile(optimizer=opt, loss=[my_loss_2_2],
			  metrics=config['metrics'])
logger.set_loss(my_loss_2_2)
logger.save()
